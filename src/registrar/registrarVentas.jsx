...
function RegistrarVentas() {
    ...
    return (
        <Fragment>
            ...
            {validUser ? <body className="body-r" >
    ...
    */}
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <p>&nbsp;&nbsp;Apellidos:&nbsp;&nbsp;<input type="text" name="a_comprador" id="a_comprador" /></p>
                                    <p>&nbsp;&nbsp;Documento:&nbsp;&nbsp;<input type="number" name="d_comprador" id="d_comprador" /></p>

                                    <input className ="btn boton-r"
                                        onClick={() => alert("El pedido se ha realizado con exito")}
                                        type="submit" href="/pedidos-realizados"
                                        value="Hacer pedido"
                                    />
                                   &nbsp;&nbsp; <input className="btn boton-r" type="reset" value="Nuevo pedido" />
                                </div>
